<p><big>ODS/CSV - solo funciona con el archivo en el raiz. la primera fila es de nombres de columnas. La latitud y longitud estilo americano, con punto para los decimales y 8 decimales</big></p>
...
if($_FILES['file']['name'] != "") {
	...
	try
	{
		...
		for ($i=1; $i<count($pois); $i++){ // diferencia: comienza en el registro 2
			...
			if ($_SESSION['usuario_id'] == 4) { // si son puntos de bomberos
				$ciudad = $pois[$i][5];
				$lugar->ciudad = $ciudad;
				$lugar->pais = "ES";
			}
